...
function MovieDetails({ selectedId, onCloseMovie, onAddWatched, watched }) {
  ...
  function handleAdd() {
    ...
    // alert(avgRating);
    // by doing it this way, we can get access to the updated value
    // for some reason...
  ...
  return (
    <div className="details">
      ...
      () => onCloseMovie -- will not work
      () => onCloseMovie() -- will work */}
